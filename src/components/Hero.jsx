...
function Hero() {
    return (
        <div className="flex flex-col lg:flex-row px-4 md:px-16 lg:px-40 py-8 min-h-[calc(100vh-6rem)]">
            ...
            <div className="relative w-full lg:w-3/5 px-6">
                    <img src={HeroImage3} width={640} alt="Image 1" className="absolute top-0"/>
                    <img src={HeroImage2} width={420} alt="Image 1" className="absolute bottom-0 left-1/2 -translate-x-1/2"/>
                    <img src={HeroImage1} width={580} alt="Image 1" className="absolute bottom-0 left-1/2 -translate-x-1/2"/>
            </div>
        </div>
    )
}
